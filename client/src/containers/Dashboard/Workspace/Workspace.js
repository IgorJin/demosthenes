...
import TasksArc from "../../../components/TasksArc";
...
const defaultTasks = [
  {
    text: "Invite to office meet-up",
    type: "Call",
    date: "December 23, 2018",
    recipient: { image: ava, name: "John Shelt" },
    status: 2,
  },
  {
    text: "Send benefit review by Sunday",
    type: "Reminder",
    date: "December 23, 2018",
    recipient: { image: ava, name: "George Fields" },
    status: 1,
  },
  {
    text: "Send benefit review by Sunday",
        ...
        <div className="dashboard__inner__main">
          <div className="dashboard__inner__item">
            <div className="dashboard__inner__item__head">
              ...
              />
              <Header>
                {curDay} {monthNames[curMonth]}, {dayOfWeek[weekDay]}
              </Header>
              <DateCarousel
                dateArr={dateArr}
                today={today}
            ...
            <div className="dashboard__inner__item__body">
              {task
                .filter((t) => new Date(t.date).getDate() == curDay)
                .map((t, i) => (
                  <TaskCard
                    info={t}
                    index={i}
                    dateStr={new Date(t.date).formatDay()}
                  />
                ))}
